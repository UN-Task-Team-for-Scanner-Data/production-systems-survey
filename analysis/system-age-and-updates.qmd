...
For the purposes of this section, we are referring to **non-trivial updates** that affect the functionality of the system.
...
More generally, across all respondents, almost one fifth of respondents indicated that the majority of their systems are **never updated**. We are very surprised by this finding. Given the impetus to incorporate alternative data sources in CPI Production Systems, we believe it would be highly undesirable to have CPI Production Systems that are never updated.
