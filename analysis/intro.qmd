...
Throughout this write up, we distinguish between software systems and IT professionals being **embedded in domain teams** versus being centralized **outside of domain teams**. Organizing system design around business domains is not a new idea in software engineering (see Domain Driven Design by @evans2004domain). However, we believe this distinction may not be well understood or formalized in the context of the Complex Analytical Systems described in @sec-why-run-this-survey, so we pay special attention to this distinction throughout this write up.
