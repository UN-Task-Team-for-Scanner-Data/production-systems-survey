...
However, Complex Analytical Systems differ from traditional software systems in a number of important aspects[^3]:
...
[^3]: We are not implying that all "typical" software systems have these characteristics. Rather, we are trying to draw contrast between aspects of Complex Analytical Systems that are most likely to be different from the kinds of systems a software engineer would often develop and maintain.
...
To this end, we hope this survey can help bridge the gap between well-understood industry best practices from the world of software engineering, and those aspects of Complex Analytical Systems that could benefit from these best practices.

More specifically, we are trying to understand the current state of Complex Analytical Systems and the teams who maintain them. Our hope is that the insights gained and the survey methodology deployed may be valuable for other Complex Analytical Systems facing similar challenges.
...
- @sec-age covers questions about the age and update frequency of certain systems.

- @sec-num-ppl covers questions about the number of individuals required to participate in certain system changes.
...
- @sec-challenges covers the challenges CPI Production Systems teams face with respect to maintaining their systems.
