...
[^3]: For readers unfamiliar with the CPI domain, this step refers to the process of combining elementary indexes into higher level indexes. For example, "Canned Salmon" and "Canned tuna" belong to a higher level category such as "Canned and other preserved fish", which in turn belongs to a higher level category like "Fish, seafood and other marine products", and so on until you reach the "All Items" CPI.
