...
# Example of "monolith" cluster
knitr::kable(sys_cluster_split[[3]][[20]])
```
...
knitr::kable(sys_cluster_split[[1]][[16]])
```
...
knitr::kable(sys_cluster_split[[2]][[6]])
```
