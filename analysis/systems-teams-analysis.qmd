...
As architectures or technical practices may be adopted differently by teams depending on their role, or their technical skillset, we categorize the initial organizations we described in the survey into new teams. Specifically:

-   **Stream Aligned team**: A system group is maintained by domain-analysts, domain-IT, or both. The idea is that domain-specific teams would have a better understanding of the prices domain and thus may choose different architectures.

-   **IT-Only team**: A system group is maintained by corporate-IT, domain-IT, or both. The idea is to differentiate technical skillsets of this team compared to analyst-only teams.

-   **Analyst-Only team**: A system group is maintained by domain-analysts, elsewhere-analysts, or both. The idea is to differentiate these to IT-Only teams.
