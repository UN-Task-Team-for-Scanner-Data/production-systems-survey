...
subtitle: Interim Report with Survey Analysis
...
Work was done by Workstream 4 (CPI Systems and Architecture), which is part of the [UN Task Team on Scanner Data](https://unstats.un.org/bigdata/task-teams/scanner/index.cshtml) under the [UN Committee of Experts on Big Data and Data Science for Official Statistics](https://unstats.un.org/bigdata/).
...
**Note**: Please consider reading the [full interim report](https://un-task-team-for-scanner-data.github.io/production-systems-survey/report-site/intro.html) that accompanies this presentation.
...
#| echo: false
#| warning: false
#| label: coupling-across-systems-teams
...
ggplot(dat, aes(x=VCS, y=Frequency)) + geom_bar(stat="identity", fill="#F1502F") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Version Control Systems Used")
...
# Fill NA with zero
dat$Frequency = ifelse(dat$Frequency == "Yes", 1, 0)
ggplot(dat, aes(x=Software, y=Frequency)) + geom_bar(stat="identity", fill="#1d6f42") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Commercial Software Used")
```
:::
::: {.column width="50%"}
...
# Fill NA with zero
dat$Frequency = ifelse(dat$Frequency == "Yes", 1, 0)
ggplot(dat, aes(x=Software, y=Frequency)) + geom_bar(stat="identity", fill="#0052CC") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Project Management Software Used")
```
:::
...
# Fill NA with zero
dat$Frequency = ifelse(dat$Frequency == "Yes", 1, 0)
ggplot(dat, aes(x=Language, y=Frequency)) + geom_bar(stat="identity", fill="#FFE873") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Programming Languages Used")
...
# Fill NA with zero
dat$Frequency = ifelse(dat$Frequency == "Yes", 1, 0)
ggplot(dat, aes(x=Storage, y=Frequency)) + geom_bar(stat="identity", fill="#FF9900") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Storage Systems Used")
...
ggplot() + aes(overall_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + labs(title="System Age Distribution (Overall)") + theme(text = element_text(size = 20))
```
:::
...
ggplot() + aes(overall_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (Overall)") + theme(text = element_text(size = 20))
...
df_use_ads <- df[df$use_ads == "Yes",]

dat_use_ads = make_update_freq_table(df_use_ads)
```
:::
...
ggplot() + aes(overall_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20))
...
ggplot() + aes(sm_overall_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + labs(title="Lead Time for Small Changes (Overall)") + theme(text = element_text(size = 20))
...
ggplot() + aes(overall_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Lead Time for Large Changes (Overall)")
...
ggplot() + aes(pct_dat) + geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="ADS Usage (Actual)")
...
ggplot() + aes(pct_dat) + geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="ADS Usage (Aspirational)")
...
ggplot(dat,aes(x=forcats::fct_infreq(Challenges))) +
  ...
  theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Challenges Faced (Rank 1 through 5)")
```
...
3. Does our survey have external validity? We have some evidence that it does, but more research is needed.

## Thanks for Listening!

<br/><br/><br/>

Please consider reading the [full interim report](https://un-task-team-for-scanner-data.github.io/production-systems-survey/report-site/intro.html) that accompanies this presentation.
...
# Fill NA with zero
dat$Frequency = ifelse(dat$Frequency == "Yes", 1, 0)
ggplot(dat, aes(x=Language, y=Frequency)) + geom_bar(stat="identity", fill="#FFE873") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="[Monolith] Programming Languages Used")
```
:::
...
# Fill NA with zero
dat$Frequency = ifelse(dat$Frequency == "Yes", 1, 0)
ggplot(dat, aes(x=Language, y=Frequency)) + geom_bar(stat="identity", fill="#FFE873") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="[Modular] Programming Languages Used")
```
:::
...
modular_df <- modular_df |> rename(
  age_ing=colnames(modular_df)[188],
  age_proc=colnames(modular_df)[189],
  age_elem=colnames(modular_df)[190],
  age_agg=colnames(modular_df)[191],
  age_fin=colnames(modular_df)[192],
  share_cpi_sys=colnames(modular_df)[193],
  update_ing=colnames(modular_df)[194],
  update_proc=colnames(modular_df)[195],
  update_elem=colnames(modular_df)[196],
  update_agg=colnames(modular_df)[197],
  update_fin=colnames(modular_df)[198]
)

monolith_df <- monolith_df |> rename(
  age_ing=colnames(monolith_df)[188],
  age_proc=colnames(monolith_df)[189],
  age_elem=colnames(monolith_df)[190],
  age_agg=colnames(monolith_df)[191],
  age_fin=colnames(monolith_df)[192],
  share_cpi_sys=colnames(monolith_df)[193],
  update_ing=colnames(monolith_df)[194],
  update_proc=colnames(monolith_df)[195],
  update_elem=colnames(monolith_df)[196],
  update_agg=colnames(monolith_df)[197],
  update_fin=colnames(monolith_df)[198]
)
...
ggplot() + aes(monolith_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + labs(title="System Age Distribution (Monolith)") + theme(text = element_text(size = 20))

modular_dat = make_age_table(modular_df)

modular_dat = factor(modular_dat, levels=age_levels)

ggplot() + aes(modular_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + labs(title="System Age Distribution (Modular)") + theme(text = element_text(size = 20))
```
...
ggplot() + aes(monolith_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (Monolith)")
...
ggplot() + aes(modular_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (Modular)")
...
ggplot() + aes(stream_aligned_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (Stream-Aligned)")
...
ggplot() + aes(it_only_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (IT-Only)")
...
ggplot() + aes(analyst_only_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (Analyst-Only)")
...
ggplot() + aes(other_mix_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Update Frequency Distribution (Other Mix)")
```
...
monolith_df <- monolith_df |> rename(
  ind_ing_sm=colnames(monolith_df)[199],
  ind_proc_sm=colnames(monolith_df)[200],
  ind_elem_sm=colnames(monolith_df)[201],
  ind_agg_sm=colnames(monolith_df)[202],
  ind_fin_sm=colnames(monolith_df)[203],
  ind_ing_lg=colnames(monolith_df)[204],
  ind_proc_lg=colnames(monolith_df)[205],
  ind_elem_lg=colnames(monolith_df)[206],
  ind_agg_lg=colnames(monolith_df)[207],
  ind_fin_lg=colnames(monolith_df)[208],
  lead_t_ing_sm=colnames(monolith_df)[209],
  lead_t_proc_sm=colnames(monolith_df)[210],
  lead_t_elem_sm=colnames(monolith_df)[211],
  lead_t_agg_sm=colnames(monolith_df)[212],
  lead_t_fin_sm=colnames(monolith_df)[213],
  lead_t_ing_lg=colnames(monolith_df)[214],
  lead_t_proc_lg=colnames(monolith_df)[215],
  lead_t_elem_lg=colnames(monolith_df)[216],
  lead_t_agg_lg=colnames(monolith_df)[217],
  lead_t_fin_lg=colnames(monolith_df)[218],
)

modular_df <- modular_df |> rename(
  ind_ing_sm=colnames(modular_df)[199],
  ind_proc_sm=colnames(modular_df)[200],
  ind_elem_sm=colnames(modular_df)[201],
  ind_agg_sm=colnames(modular_df)[202],
  ind_fin_sm=colnames(modular_df)[203],
  ind_ing_lg=colnames(modular_df)[204],
  ind_proc_lg=colnames(modular_df)[205],
  ind_elem_lg=colnames(modular_df)[206],
  ind_agg_lg=colnames(modular_df)[207],
  ind_fin_lg=colnames(modular_df)[208],
  lead_t_ing_sm=colnames(modular_df)[209],
  lead_t_proc_sm=colnames(modular_df)[210],
  lead_t_elem_sm=colnames(modular_df)[211],
  lead_t_agg_sm=colnames(modular_df)[212],
  lead_t_fin_sm=colnames(modular_df)[213],
  lead_t_ing_lg=colnames(modular_df)[214],
  lead_t_proc_lg=colnames(modular_df)[215],
  lead_t_elem_lg=colnames(modular_df)[216],
  lead_t_agg_lg=colnames(modular_df)[217],
  lead_t_fin_lg=colnames(modular_df)[218],
)
...
ggplot() + aes(monolith_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Lead Time for Large Changes (Monolith)")
...
ggplot() + aes(modular_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Lead Time for Large Changes (Modular)")
...
ggplot() + aes(stream_aligned_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20))
...
ggplot() + aes(it_only_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20))
...
ggplot() + aes(analyst_only_dat)+ geom_bar(binwidth=1, colour="black", fill="white") + theme(text = element_text(size = 20))
...
ads_methods[7,2] = sum(df$other_method != "")
...
ggplot(overall_dat,aes(x=forcats::fct_infreq(Challenges))) +
  geom_bar(alpha=1, position="stack", color="black") +
  theme(text = element_text(size = 20), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + labs(title="Ranked Alternative Data Challenges")
```
